...
```{r Bringing in the base world map for the bat species range data, warning=FALSE}
...
world_shape <- here("Data/Maps/ne_110m_admin_0_countries/ne_110m_admin_0_countries.shp") %>% st_read()
